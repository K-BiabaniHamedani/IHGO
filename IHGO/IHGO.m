...
function [gbestX,gbestweight,gbestfitness,gbestfrequencies,gbesthistory_weight,gbesthistory_fitness,FEs,e1,e2,e3,P1,P2,P3] = IHGO(nodes,elements,f,popsize,dimension,xmin,xmax,MaxFEs,run_id)
